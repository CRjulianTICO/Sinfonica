...
namespace Sinfonica.Web.Areas.User.Controllers
{
    ...
    public class EventosController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var view = from progra in  await this._context.Eventos.ToListAsync() where progra.Estado == true && progra.Fecha >= System.DateTime.Now select progra;
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var evento = await this._context.Eventos.FindAsync(id.Value);
            if (evento == null)
            {
                return NotFound();
            }
